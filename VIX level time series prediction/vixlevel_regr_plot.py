...
plt.text(-5, 65, 'RMSE=2.97, Signal_accuracy=46.6%', fontsize = 10)
...
plt.xlabel("Data points")
plt.ylabel("VIX Level")
plt.text(-5, 65, 'RMSE=3.41, Signal_accuracy=51.1%', fontsize = 10)
plt.legend(loc="upper left")
...
plt.xlabel("Data points")
plt.ylabel("VIX Level")
plt.text(-5, 65, 'RMSE=4.76, Signal_accuracy=46.7%', fontsize = 10)
plt.legend(loc="upper left")
...
plt.xlabel("Data points")
plt.ylabel("VIX Level")
plt.text(-5, 65, 'RMSE=7.43, Signal_accuracy=49.0%', fontsize = 10)
plt.legend(loc="upper left")
...
plt.xlabel("Data points")
plt.ylabel("VIX Level")
plt.text(-5, 65, 'RMSE=3.74, Signal_accuracy=48.1%', fontsize = 10)
plt.legend(loc="upper left")
...
plt.xlabel("Data points")
plt.ylabel("VIX Level")
plt.text(-5, 65, 'RMSE=4.28, Signal_accuracy=47.9%', fontsize = 10)
plt.legend(loc="upper left")
